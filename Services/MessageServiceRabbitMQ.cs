...
namespace API.Services {
    public class MessageServiceRabbitMQ: IMessageService, IDisposable {
        ...
        public MessageServiceRabbitMQ(ApplicationSettings applicationSettings) {
            ...
            _channel.QueueDeclare(queue: _applicationSettings.QueueName, durable: true, exclusive: false, autoDelete: false, arguments: null);
        }
        ...
        public void RollbackTransaction() {
            _channel.TxRollback();
            Activity.Current?.AddEvent(new ActivityEvent("RabbitMQ.Message.Rollback"));
        }
